  ...
  const quizData = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          text: "La libération d'histamine lors d'une réaction allergique",
          correct: false,
        },
      ],
      feedback: {
        correct:
          "Parfait! La phagocytose est le processus par lequel des cellules comme les macrophages et les neutrophiles englobent et digèrent des particules étrangères.",
        incorrect:
          "Incorrect. La phagocytose est le processus par lequel des cellules comme les macrophages englobent et digèrent des particules étrangères.",
      },
    },
    {
      question:
      ...
      options: [
        {
          text: "L'immunité innée est plus rapide mais moins spécifique que l'immunité adaptative",
          correct: true,
        },
        {
          text: "L'immunité innée n'existe que chez les mammifères",
          correct: false,
        },
        {
          text: "L'immunité adaptative ne nécessite pas de contact préalable avec un pathogène",
          correct: false,
        },
        {
          text: "L'immunité innée est acquise après la naissance, contrairement à l'immunité adaptative",
          correct: false,
        },
      ],
      feedback: {
        correct:
          "Excellent! L'immunité innée constitue la première ligne de défense, rapide mais peu spécifique, tandis que l'immunité adaptative est plus lente mais très spécifique et possède une mémoire immunitaire.",
        incorrect:
          "Incorrect. L'immunité innée est rapide mais peu spécifique, tandis que l'immunité adaptative est plus lente mais très spécifique et possède une mémoire immunitaire.",
      },
    },
  ];
  ...
  function showResults() {
    ...
    document.querySelector(".question-card").innerHTML = `
            <div class="results-container">
                ...
                <p class="score-message">${getScoreMessage(
                  score,
                  totalQuestions
                )}</p>
